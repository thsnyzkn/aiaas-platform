...
export function AdminKeysClient({ initialKeys }: { initialKeys: AdminKey[] }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <DesktopDataTable caption="All API keys with owner, rate limit, status, bulk selection, and actions.">
        <thead className={dataTableHeadClassName}>
          <tr>
            ...
            <th scope="col" className={dataTableHeadCellClassName}>Name</th>
            <th scope="col" className={dataTableHeadCellClassName}>Key</th>
            <th scope="col" className={dataTableHeadCellClassName}>User</th>
            <th scope="col" className={dataTableHeadCellClassName}>Rate limit</th>
        ...
        <tbody className={dataTableBodyClassName}>
          {keys.map((k) => (
            <tr key={k.id} className={dataTableRowClassName}>
